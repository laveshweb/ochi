...
cards[index].start({y : "0"})
  ...
  return (
    <div className="w-ful py-14">
      ...
      <div className="">
        <div className="cards w-full flex gap-4 mt-10 px-10">
          <div className="headings absolute bg-red-500"></div>

          <motion.div onHoverStart={()=>HandleHover(0)} onHoverEnd={()=> HandleHoverEnd(0)} className="cardContainer relative w-1/2 h-[78vh] bg-red-500 rounded-2xl ">
            <h1 className='absolute flex left-full -translate-x-1/2 top-1/2 overflow-hidden -translate-y-1/2 z-10 tracking-tight leading-none  font-semibold uppercase text-[#CDEA68] text-8xl whitespace-nowrap'>
          ...
          <motion.div  onHoverStart={()=>HandleHover(1)}   onHoverEnd={()=> HandleHoverEnd(1)} className="cardContainer relative w-1/2 h-[78vh] bg-red-500  rounded-2xl">
            <h1 className='absolute flex overflow-hidden right-full translate-x-1/2 top-1/2 -translate-y-1/2 z-10 tracking-tight leading-none  text-[#CDEA68] uppercase text-8xl  font-semibold  whitespace-nowrap '>
            ...
            <div className="w-full h-full bg-green-600 overflow-hidden">
